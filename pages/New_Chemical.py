...
def analog_finder(MFPs_address, chem_info_address, chem_smiles=None, unit_test=False, shah_id=None): # -> DataFrame
    """
            ...
            with st.container(border=True):
                ...
                if list_presence.empty:
                    ...
                    try:
                        ...
                        grouped_pucs = grouped_pucs.sort_values('Number of product names', ascending=True)
...
if smiles_ready:    
    ...
    final_table=analog_finder(FP_input_path, cd_input_path, chem_smiles=smiles_code)
