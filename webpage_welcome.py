...
st.header("Welcome to the Exposure Web App", divider=True)
st.markdown('### Choose the "Existing Chemical" page in the right-hand bar to see measured' 
            ' and predicted information on your chemical of interest.')
st.markdown('### Choose the "New Chemical" page in the right-hand bar to see' 
